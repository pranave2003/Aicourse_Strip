        ...
        child: Padding(
          ...
          child: Column(
            ...
            fit: BoxFit.cover,
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: featureList.map((feature) => _buildFeatureChip(feature)).toList(),
              ),
              ...
              GridView.count(
                ...
                children: amenitiesList.map((amenity) => _buildAmenityTile(amenity)).toList(),
              ),
              const SizedBox(height: 16),
              ...
              _buildDetailText("Bills Included", "Yes (Electricity, Wi-Fi, Hosting)"),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {},
                  child: const Text("Enquire Now", style: TextStyle(fontSize: 16, color: Colors.white)),
                ),
              ),
            ],
          ),
