...
//
// class Accomodationdetailscreen extends StatefulWidget {
//   const Accomodationdetailscreen({super.key});
//
//   @override
//   State<Accomodationdetailscreen> createState() => _AccomodationdetailscreenState();
// }
//
// class _AccomodationdetailscreenState extends State<Accomodationdetailscreen> {
...
//             ),
//             SizedBox(height:20),
//             Text("Student housing near Yale University",style: TextStyle(color:Colors.black,fontSize: 24,fontWeight: FontWeight.bold),),
//             Row(
//               children: [
//                 Expanded(
...
//               ],
//             ),SizedBox(height:20),
//             Text("Student housing near Oxford University",style: TextStyle(color:Colors.black,fontSize: 24,fontWeight: FontWeight.bold),),
//             Row(
//               children: [
//                 Expanded(
//                   child: GridView.builder(
...
//                               // borderRadius: BorderRadius.circular(10),
//                               child: Image.asset(
//                                 serviceList2[index]["icon"].toString(),
//                                 height: 140,
//                                 width: 160,
//                                 fit: BoxFit.cover,
//                               ),
