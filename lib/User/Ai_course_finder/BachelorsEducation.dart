...
class BachelorsEducation extends StatefulWidget {
  const BachelorsEducation({super.key});
      ...
      child:Column(
        children: [
          Row(
            ...
            children: [
              Text("What is your highest \n education level?",style: TextStyle(color: Color(0xff0A1F52),fontSize:20,fontWeight: FontWeight.bold),),
            ],
          ),
          SizedBox(height:10),
          GestureDetector(
          ...
          SizedBox(height:30),
          Text("What is your expected or gained \n percentage?",style: TextStyle(color: Color(0xff0B1F50),fontSize:20)),
          SizedBox(height:20),
          Container(
            decoration: BoxDecoration(
