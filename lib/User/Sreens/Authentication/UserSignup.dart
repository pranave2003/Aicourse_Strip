...
//                     // ),
//                     // const SizedBox(height: 15),
//                   buildDropdown("Country", ["India", "Canada", "United States","United Kingdom"],
...
// }
  Widget buildDropdown(String hint, List<String> items, String? selectedValue, ValueChanged<String?> onChanged) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.grey[400], // Match the background color of your text fields
        borderRadius: BorderRadius.circular(10), // Match the border radius
        // border: Border.all(color: Colors.grey), // Match the border color
      ),
