                    ...
                    children: [
                      ...
                      Expanded(
                        child: Container(
                          ...
                          padding: const EdgeInsets.symmetric(
                              vertical: 8,
                              horizontal: 25), // Align with the dropdowns
                          child: TextFormField(
                            ...
                            initialValue: selectedRank != null
                                ? selectedRank.toString()
                            ...
                            onChanged: (value) {
                              setState(() {
                                selectedRank = (int.tryParse(value.trim()) ?? 0)
                                    .toString(); // Set to 0 if invalid
                              });
                            },
                          ),
                        ),
